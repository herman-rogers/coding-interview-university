...
> My own personal additions for improving as an engineer

- [Quantum Computing](https://docs.microsoft.com/en-us/quantum/quantum-concepts-1-intro?view=qsharp-preview)
- [Linear Algebra textbook](http://joshua.smcvt.edu/linearalgebra/)
